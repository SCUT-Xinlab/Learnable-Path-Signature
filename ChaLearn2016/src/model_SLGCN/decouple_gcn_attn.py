...
import numpy as np
import math
from src.model_SLGCN.dropSke import DropBlock_Ske
from src.model_SLGCN.dropT import DropBlockT_1d
...
class unit_gcn(nn.Module):
    def __init__(self, in_channels, out_channels, A, groups, num_point, coff_embedding=4, num_subset=3):
        ...
        self.Linear_weight = nn.Parameter(torch.zeros(
            in_channels, out_channels * num_subset))
