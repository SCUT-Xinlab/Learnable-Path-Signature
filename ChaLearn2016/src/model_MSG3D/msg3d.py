...
from src.model_MSG3D.ms_gcn import MultiScale_GraphConv as MS_GCN
from src.model_MSG3D.ms_tcn import MultiScale_TemporalConv as MS_TCN
from src.model_MSG3D.ms_gtcn import SpatialTemporal_MS_GCN, UnfoldTemporalWindows
from src.model_MSG3D.mlp import MLP
from src.model_MSG3D.activation import activation_factory
...
class MSG3D_Model(nn.Module):
    def __init__(self,
                graph,
                 ...
                 num_person=1,
                 in_channels=3):
        super(MSG3D_Model, self).__init__()
...
class MSG3D_Model_2layer(nn.Module):
    def __init__(self,
                graph,
                 num_gcn_scales,
                 num_g3d_scales,
                 ...
                 num_person=1,
                 in_channels=3):
        super(MSG3D_Model_2layer, self).__init__()
